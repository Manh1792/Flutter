...
import 'package:humberger/Itemview.dart';
...
class _MainAppState extends State<MainApp> {
  ...
  List Titles = ["Hamburger", "Pizza", "Coffe", "Bánh", "Kem"];
                        ...
                        return Stack(
                          children: [
                            ...
                            Positioned(
                                child: Container(
                              margin:
                                  EdgeInsets.only(top: 40, left: 30, right: 10),
                              height: 80,
                              width: 80,
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(20)),
                            ...
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.symmetric(horizontal: 9),
                                child: Text(
                                    "“Tasty, delicious, and has me craving more on the first bite and juicy, mouthwatering, tasty, and everything you’d ever want to savor."),
                              ),
                            ],
                          ),
                        ),
